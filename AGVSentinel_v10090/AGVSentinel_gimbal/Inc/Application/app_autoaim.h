...
#define ChariotRecognition_data_dma_buf_len   64u
#define ChariotRecognition_data_len           15u
#define VISION_FRAME_CRC_OFFSET               13u
#define VISION_FRAME_END_OFFSET               14u
#define A_Size  60
...
extern uint8_t ChariqotRecognition_data[2][ChariotRecognition_data_dma_buf_len];
