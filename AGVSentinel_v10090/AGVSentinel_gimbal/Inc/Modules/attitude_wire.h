...
/* Shared wire contract, version 1. Little endian; IEEE754 binary32; wxyz.
 * Header: A6 5A, version:u8, type:u8, payload_length:u16, sequence:u32,
 * session:u64. CRC16-CCITT-FALSE covers header and payload, stored LE.
 * This header is also copied to the gimbal firmware; no native structs on wire. */
#include <stdint.h>
#include <string.h>
