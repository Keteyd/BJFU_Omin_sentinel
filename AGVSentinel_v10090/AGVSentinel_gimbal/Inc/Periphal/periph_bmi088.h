 ...
 *  LastEditTime : 2023-02-11 00:31:08
 */
...
typedef struct {
    uint32_t failed, succeeded;
    uint8_t failed_stage, hal_status, acc_id, gyro_id;
} BMI088_ReadDiagTypeDef;
extern volatile BMI088_ReadDiagTypeDef BMI088_ReadDiag;
