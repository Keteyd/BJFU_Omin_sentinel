#!/usr/bin/env python3
"""Generate the 0x59490906 second field-rebalanced gain from frozen S1."""
...
REFERENCE_DELTA_WEIGHT = np.asarray([5.0, 0.5])
...
def generate(model_path: Path) -> dict:
    ...
    return {
        ...
        "change_from_59490905": {
            "small_joint_weight": [30.0, JOINT_WEIGHT],
            "big_reference_delta_weight": [2.0, float(REFERENCE_DELTA_WEIGHT[0])],
